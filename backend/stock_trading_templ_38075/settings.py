"""
Django settings for stock_trading_templ_38075 project.
...
ROOT_URLCONF = 'stock_trading_templ_38075.urls'
...
WSGI_APPLICATION = 'stock_trading_templ_38075.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stock_trading_templ_38075 API",
    "DESCRIPTION": "API documentation for stock_trading_templ_38075 App",
    "VERSION": "v1",
}
