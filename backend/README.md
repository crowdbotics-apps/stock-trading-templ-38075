...
## Project Structure
    ...
    ├── stock_trading_templ_38075  # Django project configurations
...
1. Clone this repo and `cd stock_trading_templ_38075`
...
2. Clone this repo and `cd stock_trading_templ_38075`
